...
- Installed DD proof:
  ...
  - Result: pass, updated `capture` to version `0.02`
  ...
  - `dashboard capture.run 'printf "auto-path\\n"'`
  - Result: pass, printed the transcript and ended with `Capture saved to: /tmp/capture-...txt`
- Cleanup:
...
## Latest Verification For `DD-057`
